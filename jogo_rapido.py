...
nomes = ["Amélie", "Tom", "Ravena", "Latrel", "Estelar", "Brihanna", "Amigão", "Pade", "Kvothe", "Denna", "Auri"]
raças = ["Hobbit", "Anão", "Humano", "Draconato", "Elfo", "Felino", "Doguineo"]
classes = ["Guerreiro(a)", "Berserk", "Mago(a)", "Bardo(a)", "Monge(ja)", "Druida"]
...
def historia_inicial_salao(personagem):
    ...
    sleep(1)
    print(f"de todas as raças possíveis conversando, bebendo, rindo, gritando e muito mais. Tudo isso enquanto o bardo da casa manda ")
    sleep(1)
    print("ver em seu alaúde cantando alguma canção sobre algum lugar que talvez tenha existido.")
    sleep(1)
    ...
    sleep(1)
    print(f'ultimamente está começando a surgir um burburinho de que alguns soldados do exército de Nimb sobreviveram e estão começando a reu-')
    sleep(1)
    print(f'nir seres que estão dispostos a segui-los na jornada para trazer Nimb de volta. Fiquei sabendo que atualmente existem 5 campos des-')
    sleep(1)
